  ...
  const GetCar = async () => {
    try {
      const config = {
        headers: {
          access_token:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGJjci5pbyIsInJvbGUiOiJBZG1pbiIsImlhdCI6MTY3NTY3NjAzNX0.INrglYTuezfGnHxU43ibOnP0bikI8zKefoY38cq_71g",
        },
        params: {
          name: search.name,
        },
      ...
      const { data } = await axios.get(
        `${process.env.REACT_APP_BASE_BINAR_URL}/admin/v2/car`,
        config
      );
            ...
            <div className="row row-search-car border bg-white">
              ...
              <div className="col-12 col-lg-2 d-flex p-0">
                <div className="mb-3 input-car">
                  ...
                  <select
                    ...
                    aria-label="Masukan Kapasitas Mobil"
                  >
                    ...
                    <option
                      value="1"
                      onChange={(ev) => onSearchChange(ev, "category")}
                    >
                      2 - 4 orang
                    </option>
              ...
              <div className="col-12 col-lg-3 d-flex p-0">
                <div className="mb-3 input-car">
                  ...
                  <select
                    className="form-select"
                    aria-label="Masukan Harga Sewa per Hari"
                  >
                    <option defaultValue={"DEFAULT"}>
